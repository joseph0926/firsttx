export function BackgroundGlow() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 z-10 overflow-hidden">
      ...
      <div className="absolute top-4 -left-40 h-80 w-80 rounded-full bg-chart-2/30 blur-3xl max-sm:hidden" />
      <div className="absolute top-80 -right-10 h-80 w-80 rounded-full bg-primary/30 blur-3xl max-sm:hidden" />
      ...
      <div className="absolute inset-x-0 bottom-0 h-40 bg-linear-to-t from-background via-background/80 to-transparent max-sm:hidden" />
    </div>
  );
}
